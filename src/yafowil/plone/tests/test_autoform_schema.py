...
class IBasicModel(model.Schema):
    field = TextLine(title="Basic field", description="Basic field description")


class IBehavior1(model.Schema):
    field = TextLine(title="Behavior 1 field")


class IBehavior2(model.Schema):
    other = TextLine(title="Behavior 2 other")


class IFieldsetModel(model.Schema):
    model.fieldset("fieldset", fields=["field2"])
    field1 = TextLine(title="Default model field")
    field2 = TextLine(title="Fieldset model field")


class IFieldsetBehavior(model.Schema):
    model.fieldset("fieldset", label="Fieldset", fields=["field2"])
    field1 = TextLine(title="Default behavior field")
    field2 = TextLine(title="Fieldset behavior field")
...
class IWidgetUsingModel(model.Schema):
    ...
    # Option 1
    field1 = TextLine(title="Field 1")
    field2 = TextLine(title="Field 2")
    form.widget(field1="z3c.form.browser.text.TextWidget", field2=TextWidget)

    # Option 2
    field3 = TextLine(title="Field 3")
    form.widget("field3", TextWidget, label="Label 3")

    # Option 3
    field4 = TextLine(title="Field 4")
    form.widget("field4", label="Label 4")
...
class TestAutoformSchema(unittest.TestCase):
    def test_Fieldset(self):
        fieldset = Fieldset(
            name="default", label="Default", description="Default fieldset", order=0
        )
        ...
        field = Field(name=fieldname, schema=IBasicModel)
        fieldset.add(field)
    ...
    def test_resolve_schemata_field_order(self):
        fieldsets = resolve_schemata(
            [IOrderUsingMainSchema, IOrderUsingBehavior1, IOrderUsingBehavior2]
        )
        self.assertEqual(len(fieldsets), 1)
        ...
        self.assertEqual(
            [field.name for field in fieldset.children],
            [
                "field_2_2",
                "field_1_1",
                "field_1_2",
